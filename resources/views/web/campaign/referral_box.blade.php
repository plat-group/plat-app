    ...
    <div class="inner-box bg-primary-2  rounded-3 p-3">
        <div class="row gx-5 mb-4">
            <div class="col-md-12">
                ...
                <x-form::input name="total_budget" :value="$campaign->total_budget" readonly="true"/>
            </div>
            <div class="col-md-12 mt-4">
                ...
                <x-form::input name="referral_budget" :value="$campaign->referral_budget" readonly="true"/>
            </div>
            <div class="col-md-12 mt-4">
